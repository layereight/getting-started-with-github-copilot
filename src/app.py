...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice drills and compete in interschool basketball games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Skill development and friendly matches on the field",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and theater production rehearsal",
